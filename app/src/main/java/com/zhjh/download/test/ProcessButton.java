...
public abstract class ProcessButton extends FlatButton {
    ...
    private GradientDrawable mEmptyDrawable;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mEmptyDrawable = (GradientDrawable) getDrawable(R.drawable.rect_empty).mutate();
        mEmptyDrawable.setCornerRadius(getCornerRadius());
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int gray = getColor(R.color.gray_empty);
            int colorEmpty = attr.getColor(R.styleable.ProcessButton_pb_colorEmpty, gray);
            mEmptyDrawable.setColor(colorEmpty);
    ...
    public GradientDrawable getEmptyDrawable() {
        return mEmptyDrawable;
    }

    public void setEmptyDrawable(GradientDrawable emptyDrawable) {
